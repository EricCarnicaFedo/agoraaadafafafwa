...
<header id="navbar">
  ...
  <nav class="">
    <div class="titulonavbar">
      <img src="https://i.postimg.cc/nV2pGYsX/icone.png" alt="Logo" class="icon" style="width: 100px; height: auto; ">
...
<body>
  ...
  <section id="home-section" class="custom-welcome-section"
    style="background-image: url('https://i.postimg.cc/PJYh21zf/top-view-pet-accessories-food.jpg');">
